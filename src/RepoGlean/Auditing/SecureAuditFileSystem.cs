...
internal sealed class UnixSecureAuditEntry : ISecureAuditEntry
{
    ...
    internal static int LinuxGenericOpenFlags(Architecture architecture) =>
        0x0800 | 0x80000 | architecture switch
        {
    ...
    internal static int LinuxDirectoryOpenFlags(Architecture architecture) =>
        LinuxGenericOpenFlags(architecture) | architecture switch
        {
    ...
    private static int GenericOpenFlags() => OperatingSystem.IsMacOS()
        ...
        : LinuxGenericOpenFlags(RuntimeInformation.ProcessArchitecture);
